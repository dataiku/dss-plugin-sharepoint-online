class DSSConstants(object):
    ...
    AUTH_CERTIFICATE_APP = "app-registration-certificate"
    CHILDREN = 'children'
    ...
    PATH = 'path'
    SECRET_PARAMETERS_KEYS = ["Authorization", "sharepoint_username", "sharepoint_password", "client_secret", "client_certificate"]
    SITE_APP_DETAILS = {
        "sharepoint_tenant": "The tenant name is missing",
        "sharepoint_site": "The site name is missing",
